...
class EventsMacro {
    ...
    macro static public function build():Array<Field> {
        ...
        // TODO remove
        // Just for this test, we make the macro much slower so that we can see
        // very easily if it gets run again or not when trying to get code completion.
